...
export type CursorGridProps = {
  ...
  clickPulse?: boolean
  pulseSpeed?: number
  /** Pin the canvas behind the whole viewport instead of filling its parent. */
  fixed?: boolean
  className?: string
}
...
export default function CursorGrid({
  ...
  useEffect(() => {
    ...
    // Listen on window, not the container: as a background layer the canvas is
    // pointer-events:none, so events never reach it once content sits on top.
